...
export const amenities: Amenity[] = [
  ...
  { id: 'prep-36', name: 'Holland House School', type: 'prep_schools', coordinates: { lat: 51.6135, lng: -0.2785 }, walkTime: 24 },
  ...
  { id: 'prep-57', name: 'Northcote Lodge', type: 'prep_schools', coordinates: { lat: 51.4615, lng: -0.1695 }, walkTime: 15 },
  { id: 'prep-58', name: 'Northwood College for Girls - Junior School', type: 'prep_schools', coordinates: { lat: 51.6075, lng: -0.4225 }, walkTime: 34 },
  { id: 'prep-59', name: 'Notting Hill & Ealing High School Junior School', type: 'prep_schools', coordinates: { lat: 51.5105, lng: -0.3075 }, walkTime: 19 },
  { id: 'prep-60', name: 'Oakfield Preparatory School', type: 'prep_schools', coordinates: { lat: 51.4435, lng: -0.0885 }, walkTime: 12 },
  { id: 'prep-61', name: 'Old Palace of John Whitgift School - Preparatory Wing', type: 'prep_schools', coordinates: { lat: 51.3705, lng: -0.0975 }, walkTime: 31 },
  { id: 'prep-62', name: 'Orley Farm School', type: 'prep_schools', coordinates: { lat: 51.5835, lng: -0.3225 }, walkTime: 26 },
  { id: 'prep-63', name: 'Palmers Green High School - Junior School', type: 'prep_schools', coordinates: { lat: 51.6175, lng: -0.1105 }, walkTime: 24 },
  { id: 'prep-64', name: 'Pembridge Hall School', type: 'prep_schools', coordinates: { lat: 51.5125, lng: -0.2035 }, walkTime: 12 },
  { id: 'prep-65', name: 'The Pointer School', type: 'prep_schools', coordinates: { lat: 51.4645, lng: -0.0085 }, walkTime: 18 },
  { id: 'prep-66', name: 'Portland Place School', type: 'prep_schools', coordinates: { lat: 51.5215, lng: -0.1435 }, walkTime: 9 },
  { id: 'prep-67', name: 'Queen\'s College Preparatory School', type: 'prep_schools', coordinates: { lat: 51.5185, lng: -0.1595 }, walkTime: 10 },
  { id: 'prep-68', name: 'Queen\'s Gate Junior School', type: 'prep_schools', coordinates: { lat: 51.4955, lng: -0.1835 }, walkTime: 11 },
  { id: 'prep-69', name: 'Radnor House, Twickenham - Prep School', type: 'prep_schools', coordinates: { lat: 51.4415, lng: -0.3325 }, walkTime: 26 },
  { id: 'prep-70', name: 'St. Anthony\'s School for Girls', type: 'prep_schools', coordinates: { lat: 51.5785, lng: -0.1985 }, walkTime: 17 },
  { id: 'prep-71', name: 'St. Augustine\'s Priory - Junior School', type: 'prep_schools', coordinates: { lat: 51.5155, lng: -0.3225 }, walkTime: 21 },
  { id: 'prep-72', name: 'St. Benedict\'s Junior School', type: 'prep_schools', coordinates: { lat: 51.5125, lng: -0.3095 }, walkTime: 19 },
  { id: 'prep-73', name: 'St. Christopher\'s School', type: 'prep_schools', coordinates: { lat: 51.5505, lng: -0.1765 }, walkTime: 14 },
  { id: 'prep-74', name: 'St. Dunstan\'s College Junior School', type: 'prep_schools', coordinates: { lat: 51.4305, lng: -0.0445 }, walkTime: 17 },
  { id: 'prep-75', name: 'St. Helen\'s College', type: 'prep_schools', coordinates: { lat: 51.4935, lng: -0.4485 }, walkTime: 37 },
  { id: 'prep-76', name: 'St. John\'s Beaumont School', type: 'prep_schools', coordinates: { lat: 51.4635, lng: -0.5985 }, walkTime: 47 },
  { id: 'prep-77', name: 'St. Margaret\'s School, Hampstead - Junior School', type: 'prep_schools', coordinates: { lat: 51.5505, lng: -0.1795 }, walkTime: 14 },
  { id: 'prep-78', name: 'St. Martin\'s School', type: 'prep_schools', coordinates: { lat: 51.6075, lng: -0.4245 }, walkTime: 34 },
  { id: 'prep-79', name: 'St. Paul\'s Cathedral School', type: 'prep_schools', coordinates: { lat: 51.5135, lng: -0.0995 }, walkTime: 8 },
  { id: 'prep-80', name: 'The Study Prep', type: 'prep_schools', coordinates: { lat: 51.4245, lng: -0.2075 }, walkTime: 14 },
  { id: 'prep-81', name: 'Surbiton High Boys\' Preparatory School', type: 'prep_schools', coordinates: { lat: 51.3925, lng: -0.3095 }, walkTime: 28 },
  { id: 'prep-82', name: 'Surbiton High Girls\' Preparatory School', type: 'prep_schools', coordinates: { lat: 51.3935, lng: -0.3085 }, walkTime: 28 },
  { id: 'prep-83', name: 'Sussex House School', type: 'prep_schools', coordinates: { lat: 51.4945, lng: -0.1685 }, walkTime: 10 },
  { id: 'prep-84', name: 'Sydenham High School - Junior School', type: 'prep_schools', coordinates: { lat: 51.4275, lng: -0.0595 }, walkTime: 16 },
  { id: 'prep-85', name: 'Thomas\'s Battersea', type: 'prep_schools', coordinates: { lat: 51.4745, lng: -0.1595 }, walkTime: 13 },
  { id: 'prep-86', name: 'Thomas\'s Clapham', type: 'prep_schools', coordinates: { lat: 51.4625, lng: -0.1395 }, walkTime: 14 },
  { id: 'prep-87', name: 'Twyford School', type: 'prep_schools', coordinates: { lat: 51.5115, lng: -0.3125 }, walkTime: 20 },
  { id: 'prep-88', name: 'Westminster Cathedral Choir School', type: 'prep_schools', coordinates: { lat: 51.4955, lng: -0.1395 }, walkTime: 8 },
  { id: 'prep-89', name: 'Wetherby Prep', type: 'prep_schools', coordinates: { lat: 51.5135, lng: -0.1755 }, walkTime: 11 },
  { id: 'prep-90', name: 'Wetherby School', type: 'prep_schools', coordinates: { lat: 51.5145, lng: -0.2055 }, walkTime: 12 },
  { id: 'prep-91', name: 'Willington School', type: 'prep_schools', coordinates: { lat: 51.4235, lng: -0.2105 }, walkTime: 18 },
