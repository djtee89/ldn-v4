...
const MichelinRestaurantsSection = () => {
  ...
  const RestaurantCard = ({ restaurant }: { restaurant: MichelinRestaurant }) => (
    <Card 
      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between gap-2 mb-2">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            {restaurant.isNew && (
              <Badge variant="secondary" className="text-xs">New 2025</Badge>
            )}
  ...
  const RestaurantGrid = ({ restaurants, title, subtitle }: { 
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Discover London's finest dining experiences. Click any restaurant to search for reservations and details.
          </p>
        </div>
        ...
        <RestaurantGrid 
          ...
          subtitle="Excellent cooking, worth a detour"
        />
