...
const FilterBar: React.FC<FilterBarProps> = ({ filters, onFiltersChange, resultsCount }) => {
  ...
  const FilterControls = () => (
    <div className="space-y-3">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 h-[50px] overflow-y-auto pr-2 border border-border rounded-md p-2">
  ...
  return (
    <div className="bg-background border-b border-border">
      <div className={`container mx-auto px-4 transition-all ${isDesktopExpanded ? 'py-3' : 'py-1.5'}`}>
